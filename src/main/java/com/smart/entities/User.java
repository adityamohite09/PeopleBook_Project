...
public class User {
	...
	@Size(min=3,max=15,message=" min 2 and max 15 character are allowed.!")
	private String name;
	@Column(unique=true)
	@NotBlank(message="email must be required")
	private String email;
	@NotBlank(message="password must be required")
	@Size(min=4,max=255,message="min 4 and max 15 character are allowed.!")
	@Column(length=255)
	...
	public String toString() {
		return "User [id=" + id + ", name=" + name + ", email=" + email + ", password=" + password + ", role=" + role
				...
				+ ", isEnable()=" + isEnable() + ", getImageurl()=" + getImageurl() + ", getAbout()=" + getAbout()
